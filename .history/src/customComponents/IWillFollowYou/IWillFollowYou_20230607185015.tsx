  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "10px 16px",
        borderRadius: "8px",
        border: light["colorErrorBorder"], // Adjust the border color based on your styling
        backgroundColor: "rgba(255, 241, 240, 0.1)", // Adjust the background color based on your styling
