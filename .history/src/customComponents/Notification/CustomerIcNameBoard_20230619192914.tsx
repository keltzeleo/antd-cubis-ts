...
const CustomerIcNameBoard: React.FC<CustomerIcNameBoardProps> = ({
  ...
  const greyColour = "rgba(11,40,50, 0.3)"; // Replace with your desired grey color value
  const darkerColour = mix(0.95, idTypeBgColour, greyColour); // Adjust the darkness level (0.2) as per your preference
