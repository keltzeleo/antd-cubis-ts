  ...
  return (
    <div className={boardClassName} style={{ padding: "20px", width: "90%" }}>
      ...
      <p>
        ...
        form or an account registration: "This I/C number is not currently
        registered in our system. Please proceed with the New Registration
        process." or "This I/C number is currently registered in our system with
        x number of account(s). Please proceed with the New Registration
        process."
      </p>
    </div>
  );
