...
const CustomerIcNameBoard: React.FC<CustomerIcNameBoardProps> = ({
  ...
  const backgroundHue = adjustHue(0.5, idTypeBgColour); // Extract the hue from the background color
  const greyColour = "rgba(20,15,20, 0.30)"; // Replace with your desired grey color value
  const darkerColour = mix(0.35, backgroundHue, greyColour); // Adjust the darkness level (0.2) as per your preference
