...
const CustomerIcNameBoard: React.FC<CustomerIcNameBoardProps> = ({
  ...
  const greyColour = "rgba(19,15,13, 0.62)"; // Replace with your desired grey color value
  const darkerColour = mix(0.55, idTypeBgColour, greyColour); // Adjust the darkness level (0.2) as per your preference
