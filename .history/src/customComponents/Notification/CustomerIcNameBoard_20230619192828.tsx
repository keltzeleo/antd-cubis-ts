...
const CustomerIcNameBoard: React.FC<CustomerIcNameBoardProps> = ({
  ...
  const greyColour = "rgba(128, 128, 128, 0.3)"; // Replace with your desired grey color value
  const darkerColour = mix(0.05, idTypeBgColour, greyColour); // Adjust the darkness level (0.2) as per your preference
