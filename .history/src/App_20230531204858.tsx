...
interface Props {
  onChange?: (theme: typeof lightTheme | typeof darkTheme) => void;
}
...
const ThemeToggle = ({ onChange }: Props) => {
  ...
  return <Switch checked={theme === darkTheme} onChange={toggleTheme} />;
};
        ...
        <div>
          ...
          >
            ...
            >
              ...
              >
                <span>
                  /// /// //// &nbsp; &nbsp;For Customer who wants to apply
                  water supply in new location, document and plumber enquiries.{" "}
                </span>
              </ProCard>
