...
export interface DataSourceType {
  ...
  eventItem?: string;
  itemQuantity?: number;
  itemChargeRate?: string | undefined;
  itemAmount?: string;
...
const mockData: DataSourceType[] = [
  {
    ...
    eventItem: "01 - Bil A",
    itemQuantity: 5,
    itemChargeRate: "20.00", // Use strings with two decimal places
    itemAmount: "100.00", // Initialize with 0.00
  ...
  },
  {
    ...
    eventItem: "02 - Bill B",
    itemQuantity: 3,
    itemChargeRate: "15.00",
    itemAmount: "45.00", // Initialize with 0.00
...
mockData.forEach((item) => {
  ...
  const rate = parseFloat(item.itemChargeRate || "0"); // Treat itemChargeRate as a string with two decimal places
...
const StationBill: React.FC<StationBillProps> = ({ theme }) => {
  ...
  const columns: ProColumns<DataSourceType>[] = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>
          RM {record.itemChargeRate !== undefined ? record.itemChargeRate : ""}
        </span>
      ),
    },
    {
