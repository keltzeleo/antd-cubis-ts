...
import ProFieldDigit from '@ant-design/pro-field/lib/components/Digit';
  ...
  const columns: ProColumns<DataSourceType>[] = [
    ...
    },
    {
      ...
      renderFormItem: (item, { defaultRender, ...rest }) => {
        // Customize the decimal places using fieldProps
        const customFieldProps = {
          precision: 2, // Set the number of decimal places
        };

        return (
           <ProFieldDigit {...item} fieldProps={customFieldProps} {...rest} />;
          );
      },
