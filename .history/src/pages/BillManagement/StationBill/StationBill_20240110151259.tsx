...
const StationBill: React.FC<StationBillProps> = ({ theme }) => {
  ...
  const [maskedInputCount, setMaskedInputCount] = Array(10).fill("•").join("");
  ...
  const handleAccountNumberChange = (
    ...
    // Update inputDigits state with entered digits and remaining dots
    const updatedMaskedInputCount = sanitizedValue.padEnd(10, "•");
    setMaskedInputCount(updatedMaskedInputCount);
  };
