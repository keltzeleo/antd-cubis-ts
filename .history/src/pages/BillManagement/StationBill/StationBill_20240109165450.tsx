...
const StationBill: React.FC<StationBillProps> = ({ theme }) => {
  ...
  <div style={{ display: 'flex', justifyContent: 'flex-end', padding: '10px' }}>
    <div style={{ textAlign: 'right' }}>
      <div><strong>Total Government Service Charge Amount:</strong></div>
      <div><strong>Total Tax Amount:</strong></div>
      <div><strong>Total Bill Amount:</strong></div>
    </div>
    <div style={{ width: '150px', textAlign: 'right' }}>
      <div>RM {totalGovernmentServiceChargeAmount.toFixed(2)}</div>
