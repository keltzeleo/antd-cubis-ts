  ...
  const columns: ProColumns<DataSourceType>[] = [
    ...
    },
    {
      ...
      renderFormItem: (text, { record }) => {
        // Customize the form item for itemChargeRate
        const fieldProps = {
          step: 0.01, // Adjust the step for decimal places
          precision: 2, // Set the precision for 2 decimal places
          padding: 0,
          margin: 0,
        };

        // Apply custom styles to align with other input fields
        const customStyles = {
          lineHeight: "initial", // Adjust lineHeight if necessary
        ...
        return <ProFormDigit fieldProps={fieldProps} style={customStyles} />;
      },
      ...
      render: (text, record) => {
        ...
        return (
          <span style={{ color: theme.colorText, marginInline: 10 }}>
