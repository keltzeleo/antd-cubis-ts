...
const StationBill: React.FC<StationBillProps> = ({ theme }) => {
  ...
  const columns: ProColumns<DataSourceType>[] = [
...

    {
      ...
      render: (text, record) => {
        // Use parseFloat to ensure itemChargeRate is a valid number
        const itemChargeRate = parseFloat(record.itemChargeRate);
        ...
        if (!isNaN(itemChargeRate)) {
          ...
          return null; // Handle the case where itemChargeRate is not a valid number
        }
      },
      readonly: true,
    },
