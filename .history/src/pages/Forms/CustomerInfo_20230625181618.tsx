...
// Define handleSearch function outside the component
const handleSearch = (input: string, option: string) =>
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              ...
              <Select
                ...
                filterOption={handleSearch as any} // Apply "as any" assertion to bypass type-checking
                dropdownRender={(menu) => (
                  <div>
                    <div
                      style={{
              ...
              >
                {countries.map((country) => (
                  <Option key={country.value} value={country.value}>
                    <span style={{ marginRight: 8 }}>{country.label}</span>
                    <img
                      src={`https://restcountries.com/data/${country.value.toLowerCase()}.svg`}
                      alt={country.label}
