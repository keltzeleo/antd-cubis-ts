...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  const validateDigitsOnly = (rule, value, callback) => {
    // Add your validation logic here
    // For example, if you want to allow only digits:
    if (!/^\d+$/.test(value)) {
  ...
  const onHomeNumberChange = (value) => {
    setHomeNumber(value);
  };

  const onAlternativeNumberChange = (value) => {
