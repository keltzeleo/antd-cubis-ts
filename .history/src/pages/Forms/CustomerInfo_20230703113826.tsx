            ...
            <Row gutter={16}>
              ...
              <Col span={12}>
                <ProFormText
                  ...
                  rules={[
                    { required: true, message: "Please enter Home Number" },
                    {
                      validator: validateDigitsOnly,
                    },
                  ]}
      ...
      {currentStep === 1 && (
        <div>
          ...
          >
            <Select
              style={{ width: "100%" }}
              onChange={(values: any) => setAddressData(values)}
              mode="tags"
          ...
          >
            <Select
              ...
              onChange={(value: string) => setPostcode(value)}
              showSearch
              optionFilterProp="children"
              filterOption={(input, option) =>
                option?.children
            ...
            >
              {postcodeData.map((postcode) => (
                <Select.Option key={postcode.value} value={postcode.value}>
                  {postcode.value}
                </Select.Option>
              ))}
            </Select>
