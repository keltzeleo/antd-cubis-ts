      ...
      >
        ...
        <div>
          {currentStep === Step.length - 1 ? (
            <>
              {(currentStep === currentStepAccountEntry + 0) === 0 ? ( // Check if current step is the "Account Entry" step
                <Button
                  type="primary"
                  onClick={() => setCurrentStep(currentStepAccountEntry - 1)} // Go to the "Account Category and Usage" step of StepAccountEntry
                  disabled={!isStepValid(currentStep)}
                >
                  Next
                </Button>
