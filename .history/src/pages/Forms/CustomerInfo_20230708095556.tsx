...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  return (
    <div style={{ padding: "16px" }}>
      ...
      <ProForm submitter={false}>
        ...
        <Col span={12}>
          <Form.Item
            ...
            name="consumerGroup"
            rules={[{ required: true, message: 'Consumer Group is required' }]}
          >
            <Select>
              {/* Retrieve and map the drop-down list data */}
      ...
      <Row gutter={16}>
        <Col span={12}>
          <Form.Item
            label="Consumer Type"
            name="consumerType"
            rules={[{ required: true, message: 'Consumer Type is required' }]}
          >
            <Select>
              {/* Retrieve and map the drop-down list data */}
              {/* Option 1: code + abbreviation description */}
        ...
        <Col span={12}>
          <Form.Item
            label="Supply Type"
            name="supplyType"
            rules={[{ required: true, message: 'Supply Type is required' }]}
          >
            <Select>
              {/* Option values: P-Permanent, T-Temporary Supply */}
      ...
      {/* Render Temporary Supply End Date based on Supply Type */}
      {form.getFieldValue('supplyType') === 'T' && (
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item
              ...
              name="supplyEndDate"
              rules={[
                { required: true, message: 'Temporary Supply End Date is required' },
