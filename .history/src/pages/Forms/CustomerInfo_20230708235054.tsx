    ...
    <div style={{ padding: "16px" }}>
      ...
      >
        Previous
          ...
          <div>
            {currentStep === StepAccountEntry ? ( // Check if current step is the "Refund Information" section
              <Button
                style={{ marginRight: 8 }}
              ...
              <Button
                style={{ marginRight: 8 }}
                onClick={() => setCurrentStep(currentStep - 1)} // Navigate to the previous step (excluding "Refund Information")
                disabled={!isStepValid(currentStep)}
              >
                Previous
              </Button>
