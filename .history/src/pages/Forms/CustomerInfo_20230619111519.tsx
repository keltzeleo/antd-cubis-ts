...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  const handleNamePrefixChange = (value: string | undefined) => {
    // setNamePrefix(value); // Uncomment this line if you need to update the name prefix in the parent component
  };

  const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setName(e.target.value);
    onNameChange(e); // Call the onNameChange callback provided by the parent component
  };
