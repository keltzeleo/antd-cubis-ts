...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  return (
    <div style={{ padding: "8px", minWidth: "100%" }}>
...
<div style={{ position: "fixed", right: 10, bottom: 0, padding: "16px", width: "100%", backgroundColor: "#f5f5f5" }}>
  <div style={{ display: "flex", justifyContent: "space-between" }}>
    <div>
      {currentStep === 0 ? (
        ...
        <Button
          style={{ marginRight: 8 }}
          onClick={() => {
            if (currentStep === Step.findIndex((step) => step.title === "Account Entry")) {
              if (currentStepAccountEntry === 0) {
    ...
    <div style={{ display: "flex", justifyContent: "flex-end", maxWidth: "50%" }}>
      {currentStep === Step.length - 1 ? (
        <>
          {currentStep === Step.findIndex((step) => step.title === "Account Entry") ? (
            <>
