...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  const [homeNumber, setHomeNumber] = useState<number | undefined>(undefined);
  ...
  const validateDigitsOnly = (
    _: any,
    value: number | undefined,
    callback: (message?: string) => void
  ) => {
    if (value && !Number.isInteger(value)) {
      callback("Please enter digits only.");
    } else {
      callback();
    }
  };

  const onMobileNumberChange = (value: number | undefined) => {
    setMobileNumber(value?.toString() || "");
  };

  const onHomeNumberChange = (value: number | undefined) => {
    setHomeNumber(value?.toString() || "");
  };

  const onAlternativeNumberChange = (value: number | undefined) => {
    setAlternativeNumber(value?.toString() || "");
  };
          ...
          <ProForm.Group>
            <ProFormDigit
              ...
              fieldProps={{
                ...
                value: mobileNumber ? parseInt(mobileNumber, 10) : undefined,
            ...
            <ProFormDigit
              ...
              fieldProps={{
                ...
                value: homeNumber ? parseInt(homeNumber, 10) : undefined,
                onChange: onHomeNumberChange,
              }}
            />
            <ProFormDigit
