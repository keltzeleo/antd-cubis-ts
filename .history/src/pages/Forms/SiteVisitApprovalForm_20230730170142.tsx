...
const SiteVisitApprovalForm: React.FC<SiteVisitApprovalFormProps> = ({
 ...
 <ProForm
        ...
        >
          <Row gutter={16}>
            <Col span={12}>
              <ProFormText name="No" label="Sequence No" />
            </Col>
            <Col span={12}>
              <ProFormText name="Task" label="Task Description" />
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={12}>
            ...
            <Col span={12}>
              <ProFormDatePicker name="VisitDate" label="Visit Date" />
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={12}>
              <ProFormSelect name="Status" label="Visit Status" options={[]} />
            </Col>
            <Col span={12}>
              <ProFormSelect name="Reason" label="Non Compliance Reason" options={[]} />
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={24}>
