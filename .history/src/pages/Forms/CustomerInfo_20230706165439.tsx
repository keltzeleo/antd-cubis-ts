          ...
          <div style={{ padding: "0" }}>
            ...
            <ProCard
              ...
              extra={
                <Switch
                  ...
                  checked={consolidatedFormEditable}
                  onChange={handleConsolidatedFormToggle}
                />
              }
            >
              <ProForm.Group>
                <Row gutter={16}>
                  <Col span={12}>
                    <ProFormText
                      ...
                      name="branch"
                      label="Branch Site"
                      disabled={!consolidatedFormEditable}
                    />
                  </Col>
                  <Col span={12}>
                    <ProFormText
            ...
            {addAccountFormVisible && (
              <ProCard title="Add Account Form">
                {/* Add your "Add Account" form fields here */}
              </ProCard>
            )}
          </div>
        )}
