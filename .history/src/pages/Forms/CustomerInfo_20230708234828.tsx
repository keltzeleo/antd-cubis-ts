    ...
    <div style={{ padding: "16px" }}>
      ...
      >
        Previous
          ...
          <div>
            {currentStep === StepAccountEntry.length - 1 ? ( // Check if current step is the last step of the "Refund Information" section
              <Button
                style={{ marginRight: 8 }}
              ...
              <Button
                style={{ marginRight: 8 }}
                onClick={() => setCurrentStep(currentStep - 1)} // Navigate to the previous step (excluding the last step of "Refund Information")
                disabled={!isStepValid(currentStep)}
              >
                Previous
              </Button>
