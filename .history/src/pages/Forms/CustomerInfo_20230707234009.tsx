...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  useEffect(() => {
    form.setFieldsValue({ supplyType: "P" });
  }, []);
        ...
        {currentStep === 3 && (
          <div style={{ padding: "0" }}>
            ...
            <Form layout="vertical">
              ...
              >
                <Select>{/* Options for Account Category and Usage */}</Select>
              </Form.Item>
              ...
              <Form.Item
                ...
                name="meterType"
                style={{ background: "#ffffff" }}
                rules={[{ required: true, message: "Meter Type is mandatory" }]}
              >
                <Select>
              ...
              <Form.Item
                ...
                name="bankCode"
                style={{ background: "#ffffff" }}
                rules={[{ required: true, message: "Bank Code is mandatory" }]}
              >
                <Select>
