    ...
    <div style={{ padding: "16px" }}>
      ...
      >
        Previous
          ...
          <div>
            {currentStep === currentStepAccountEntry ? ( // Check if current step is the "Refund Information" step
              <Button
                style={{ marginRight: 8 }}
                onClick={() => setCurrentStepAccountEntry} // Go back to "Account Category and Usage" step
                disabled={!isStepValid(currentStep)}
              >
                Previous
              </Button>
              ...
              <Button
                style={{ marginRight: 8 }}
                onClick={() => setCurrentStep(currentStep - 1)} // Navigate to the previous step
                disabled={!isStepValid(currentStep)}
              >
                Previous
              </Button>
      ...
      >
        Previous
                        ...
                        <div>
                          {currentStep === curStepAccountEntry ? ( // Check if current step is the "Refund Information" step
                            <Button
                              style={{ marginRight: 8 }}
                              onClick={handlePrevStepAccountEntry} // Go back to "Account Category and Usage" step
                              disabled={!isStepValid(currentStep)}
                            >
                              Previous
                            </Button>
