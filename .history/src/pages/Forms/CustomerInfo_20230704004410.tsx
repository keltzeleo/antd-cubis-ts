...
interface CustomerInfoProps {
  ...
  othersContactNumber: number;
  citizenship: string;
  nationality: string | null;
  onCustomerTitleChange: (value: string | undefined) => void;
  onCustomerNameChange: (value: string) => void;
  onMobileNumberChange: (value: number) => void;
  onHomeNumberChange: (value: number) => void;
  onAlternativeNumberChange: (value: number) => void;
  onOthersContactNumber: (value: number) => void;
