...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  const [consolidatedFormEditable, setConsolidatedFormEditable] = useState(false);
  ...
  const isStepValid = (step: number): boolean => {
    switch (step) {
      ...
      case 3:
        // Add your validation logic for the consolidated form and the "Add Account" form if needed
        return true;
      default:
        return false;
    }
