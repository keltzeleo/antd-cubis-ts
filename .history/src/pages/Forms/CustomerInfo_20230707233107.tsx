...
const AccountForm = () => {
  const [form] = Form.useForm(); // Use `Form.useForm` correctly

const handleSupplyTypeChange = (value: string) => {
  if (value === "P") {
    Form.setFieldsValue({ temporarySupplyEndDate: undefined }); // Reset Temporary Supply End Date
  }
};

const handleAccountFormSubmit = (values: any) => {
        ...
        {currentStep === 3 && (
          <div style={{ padding: "0" }}>
            ...
            {addAccountFormVisible && (
              <ProCard title="Add Account Form">
                <Form
                  form={form}
                ...
                >
                  <Form.Item
                    label="Account Category and Usage"
                    name="accountCategoryAndUsage"
                    style={{ background: "#f9f9f9" }}
                  >
                    <Select>
                      {/* Options for Account Category and Usage */}
                    </Select>
                  </Form.Item>
                  ...
                  <Form.Item
                    ...
                    rules={[{ required: true, message: "Tariff is mandatory" }]}
                  >
                    <Select>
                      {/* Fetch and map tariff options from TariffControl table */}
                      {/* Option value should be the TariffCode */}
                      {/* Option label should be the code + short description */}
                    </Select>
                  </Form.Item>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Consumer Group is mandatory",
                      },
                    ]}
                  >
                    <Select>
                      {/* Fetch and map consumer group options based on selected tariff */}
                      {/* Option value should be the ConGroup */}
                      {/* Option label should be the code + abbreviation description */}
                    </Select>
                  </Form.Item>

                  {/* Repeat the above pattern for Consumer Type, Supply Type, and Temporary Supply End Date */}
                  ...
                  <Form.Item
                    ...
                    style={{ background: "#ffffff" }}
                    rules={[
                      { required: true, message: "Supply Type is mandatory" },
                    ]}
                  >
                    <Select onChange={handleSupplyTypeChange}>
                      <Option value="P">Permanent Supply</Option>
                      <Option value="T">Temporary Supply</Option>
                    </Select>
                  </Form.Item>

                  <Form.Item
                    label="Temporary Supply End Date"
                    name="temporarySupplyEndDate"
                    style={{ background: "#ffffff" }}
                  >
                    <DatePicker />
                  </Form.Item>

                  {/* Repeat the above pattern for Corporate Account and Corporate Group */}
                  ...
                  <Form.Item
                    ...
                    style={{ background: "#ffffff" }}
                  >
                    <Checkbox>Corporate Account</Checkbox>
                  </Form.Item>
                  ...
                  >
                    <Select>
                      {/* Fetch and map corporate group options from CorporateGroup table */}
                      {/* Option value should be the code */}
                      {/* Option label should be the code + description */}
                    </Select>
                  </Form.Item>

                  {/* Repeat the above pattern for Meter Type and Bill Delivery Type */}
                  ...
                  >
                    <Select>
                      <Option value="1">Individual Meter</Option>
                      <Option value="2">Bulk Meter</Option>
                    </Select>
                  </Form.Item>
                  ...
                  >
                    <Select>
                      {/* Option value should be the code (S, P, G) */}
                      {/* Option label should be the code + description */}
                    </Select>
                  </Form.Item>

                  {/* Repeat the above pattern for GST Relief and Document Check List Button */}
                  ...
                  <Form.Item
                    ...
                    style={{ background: "#ffffff" }}
                  >
                    <Checkbox>GST Relief</Checkbox>
                  </Form.Item>

                  <Form.Item
                    label="Document Check List Button"
                    name="documentCheckListButton"
                    style={{ background: "#ffffff" }}
                  >
                    <Button type="primary">Document Check List Button</Button>
                  </Form.Item>

                  {/* Repeat the above pattern for Bank Code, Bank Name, and Bank Account No */}
                  ...
                  <Form.Item
                    ...
                    style={{ background: "#ffffff" }}
                    rules={[
                      { required: true, message: "Bank Code is mandatory" },
                    ]}
                  >
                    <Select>
                      {/* Fetch and map bank options from Bank table */}
                      {/* Option value should be the BankCode */}
                      {/* Option label should be the code + description */}
                    </Select>
                  </Form.Item>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Bank Account No is mandatory",
                      },
                    ]}
                  >
                    <Input />
