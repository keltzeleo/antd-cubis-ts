...
const CustomerInfo: React.FC<CustomerInfoProps> = ({
  ...
  useEffect(() => {
    form.setFieldsValue({ supplyType: "" });
  }, []);

  const handleSupplyTypeChange = (value: string) => {
    form.setFieldsValue({ supplyEndDate: undefined });
  };
        ...
        {currentStep === 3 && (
          <div style={{ padding: "0" }}>
            ...
            <Form form={form} layout="vertical">
              ...
              form.getFieldValue("supplyType") === "P" ? (
                <Row gutter={16}>
                  <Col span={12}>
                    <Form.Item
                      noStyle
                    ...
                    >
                      {({ getFieldValue }) =>
                        (getFieldValue("supplyType") === "T" ||
                          getFieldValue("supplyType") === "P") && (
                          <Row gutter={16}>
                            <Col span={12}>
                              <Form.Item
                                ...
                                rules={[
                                  {
                                    required: true,
                                    message:
                                      "Temporary Supply End Date is required",
                                  },
                                ]}
                              >
                                <DatePicker />
