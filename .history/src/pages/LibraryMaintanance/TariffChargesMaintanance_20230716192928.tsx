...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  const handleEdit = (recordKey: React.Key) => {
    setDataSource((prevDataSource) =>
      prevDataSource.map((item) => ({
        ...item,
        isEditing: item.key === recordKey,
        nestedData:
          item.key === recordKey
    ...
    setExpandedRowKeys((prevExpandedRowKeys) => new Set([
      ...prevExpandedRowKeys,
      recordKey,
    ]));
  };
      ...
      <ProTable<TariffChargesDataType>
        ...
        expandable={{
          ...
          onExpand: (expanded, record) => {
            if (expanded) {
              setExpandedRowKeys((prevExpandedRowKeys) =>
                new Set([...prevExpandedRowKeys, record.key])
              );
            } else {
              setExpandedRowKeys((prevExpandedRowKeys) => {
                const keys = new Set(prevExpandedRowKeys);
