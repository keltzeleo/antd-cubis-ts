      ...
      content: (
        <Form form={formRef.current}>
          <Form.Item
            name="tariffCode"
            label="Tariff Code"
            rules={[{ required: true, message: "Please enter a tariff code" }]}
          >
            <Input />
          </Form.Item>
          <Form.Item
            name="tariffAbbreviation"
            label="Tariff Abbreviation"
            rules={[
              { required: true, message: "Please enter a tariff abbreviation" },
            ]}
          >
            <Input />
          </Form.Item>
          <Form.Item
            ...
            label="Monthly Minimum Charges"
            rules={[
              { required: true, message: "Please enter the minimum charges" },
            ]}
          >
            <InputNumber />
          </Form.Item>
    ...
    formRef.current
      ...
      .then((values) => {
        const newRecord: TariffChargesDataType = {
          ...
          tariffAbbreviation: values.tariffAbbreviation,
          monthlyMinimumCharges: values.monthlyMinimumCharges,
          effectiveDate: "",
          createdBy: "John Doe",
        ...
        setDataSource((prevDataSource) => [...prevDataSource, newRecord]);
        ...
        <ProTable<TariffChargesDataType>
          ...
          toolbar={{
            actions: [
              ...
              <Button key="addNew" type="primary" onClick={handleAddNewRecord}>
                Add New
              </Button>,
            ],
          }}
