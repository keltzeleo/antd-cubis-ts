      ...
      render: (text: any, record: DataSourceType, _, action) => (
        ...
        >
          ...
          >
            <Button
              type="primary"
              onClick={() => handleEdit(record.key, record as DataSourceType)}
            >
              Edit
            </Button>
            ...
            <Button
              ...
              danger
              icon={<DeleteOutlined />}
              onClick={() => handleDelete(undefined, record as DataSourceType)}
            >
              Delete
            </Button>
          </Space>
          ...
          >
            <Button
              type="primary"
              onClick={() => handleSave(record.key, record as DataSourceType)}
            >
              Save
            </Button>
            ...
            <Button
              type="primary"
              danger
              onClick={() => handleCancel(undefined, record as DataSourceType)}
            >
              Cancel
            </Button>
          </Space>
