...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  const handleEditMonthlyMinimumCharges = (
    ...
    setDataSource((prevDataSource) =>
      prevDataSource.map((item) =>
        item.key === record.key
          ? { ...item, monthlyMinimumCharges: value }
          : item
      )
    );
  };
  ...
  const columns: ColumnType<TariffChargesDataType>[] = [
    ...
    },
    {
      ...
      key: "effectiveDate",
      render: (text: Moment | null, record: TariffChargesDataType) =>
        editData[record.key] ? (
          <DatePicker
            defaultValue={text}
            onChange={(value) =>
          ...
          renderText(text?.format("YYYY-MM-DD"))
        ),
    },
  ...
  const nestedColumns: ColumnType<NestedDataType>[] = [
    ...
    },
    {
      ...
      dataIndex: "effectiveDate",
      key: "effectiveDate",
      render: (text: Moment | null) => renderText(text?.format("YYYY-MM-DD")),
    },
    ...(showAdditionalColumns
      ? [
          {
...
const EditableTable: React.FC<EditableTableProps> = ({
  ...
  const columns: ColumnType<NestedDataType>[] = [
    ...
    },
    {
      ...
      dataIndex: "effectiveDate",
      key: "effectiveDate",
      render: (text: Moment | null, record: NestedDataType) => (
        <DatePicker
          defaultValue={text}
