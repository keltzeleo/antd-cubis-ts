import { Line } froEditableTablem "@ant-design/charts";
...
const EditableTable: React.FC<EditableTableProps> = ({ theme }) => {
  ...
  const [showBlockConsumptionsRates, setShowBlockConsumptionsRates] = useState(true);
