import { Annotation, Line } from "@ant-design/charts";
    ...
    expandedRowRender: (record: DataSourceType) => {
      ...
      const config = {
        ...
        geometries: [
          ...
          {
            type: "line",
            start: ["min", midPoint], // [x, y] coordinates for the starting point of the line
            end: ["max", midPoint], // [x, y] coordinates for the ending point of the line
            style: {
              stroke: "gray",
              lineDash: [4, 2],
            },
      ...
      return (
        <ProCard>
          ...
          <Annotation.Annotation {...verticalLine} />
        </ProCard>
      );
    },
