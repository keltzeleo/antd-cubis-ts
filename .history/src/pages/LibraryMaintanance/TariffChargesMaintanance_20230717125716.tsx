...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  const [nestedEditingRecordKey, setNestedEditingRecordKey] = useState<React.Key | null>(null);
              ...
              return (
                <Form form={nestedFormRef.current}>
                  <ProTable<NestedDataType>
                    ...
                    editable={{
                      type: "multiple",
                      editableKeys: nestedEditingRecordKey ? [nestedEditingRecordKey] : [],
                          ...
                          if (item.key === record.key) {
                            return {
                              ...
                              nestedData: item.nestedData?.map((nestedItem) =>
                                nestedItem.key === rowKey ? { ...nestedItem, ...row } : nestedItem
                              ),
                            };
                          }
                          return item;
