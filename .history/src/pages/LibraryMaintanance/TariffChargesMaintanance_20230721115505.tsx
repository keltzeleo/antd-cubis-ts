    ...
    },
    {
      ...
      render: (_, record) => {
        if (record.isEditing) {
          return (
            <Form.Item
              name={[`${record.key}-${nestedItem.key}`, "rate1"]}
                      ...
                      },
                      {
                        ...
                        render: (text, nestedRecord) => {
                          if (nestedRecord.isEditing) {
                            return (
                              <Form.Item
                                name={[`${record.key}-${nestedRecord.key}`, "block"]}
                            ...
                            return (
                              <span style={{ color: theme.colorText }}>
                                {nestedRecord.block ? `${nestedRecord.block[0]} - ${nestedRecord.block[1]}m³` : ""}
                              </span>
                            );
                          }
                        },
                      },
                      {
                        ...
                        render: (text, nestedRecord) => {
                          if (nestedRecord.isEditing) {
                            return (
                              <Form.Item
                                name={[`${record.key}-${nestedRecord.key}`, "rate"]}
                            ...
                            return (
                              <span style={{ color: theme.colorText }}>
                                RM {nestedRecord.rate !== undefined ? nestedRecord.rate.toFixed(2) : ""}
                              </span>
                            );
                          }
                        },
