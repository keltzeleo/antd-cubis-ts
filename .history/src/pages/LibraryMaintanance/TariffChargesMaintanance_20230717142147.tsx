...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  const nestedColumns: ProColumns<NestedDataType>[] = [
    ...
    },
    {
      ...
      render: (_, record) => {
        if (record.isEditing) {
          // Render the editable field with saved value
          return (
            <Form.Item
        ...
        // Render the plain text representation of saved value
        return <span style={{ color: theme.colorText }}>{record.block}</span>;
      },
    },
    {
      title: "Rate",
