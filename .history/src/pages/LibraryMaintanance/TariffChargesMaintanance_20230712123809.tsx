...
interface NestedDataType {
  key: string;
  status: string;
  block: [number, number]; // Updated data type to be compatible with ProFormDigitRange
  rate: number; // Updated data type to be compatible with ProFormDigit
  effectiveDate: string | number | Date; // Updated data type to be compatible with ProFormDatePicker
  createdBy: string;
  createDate: string;
  modifiedBy: string;
  modifiedDate: string;
...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  // Apply theme color to the parent container of ProTable
