        ...
        <ProCard>
          <Row gutter={16}>
            {record.nestedData.map((nestedItem, index) => (
              <Col span={24} key={nestedItem.key}>
                <ProCard style={{ marginBottom: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                    <div style={{ fontWeight: 'bold' }}>0{index + 1}</div>
                    <div>
                      <p style={{ marginBottom: '4px' }}><strong>Effective Date:</strong> {nestedItem.effectiveDate}</p>
                      <p style={{ marginBottom: '4px' }}><strong>Block:</strong> {nestedItem.block}</p>
