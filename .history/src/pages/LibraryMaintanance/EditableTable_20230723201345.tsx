...
const defaultData: DataSourceType[] = [
  {
    ...
    blockConsumption3: [50, 100], // Corrected to use an array of numbers
  ...
  },
  {
    ...
    ratespercubicm3: 0.11, // Corrected to be a number
    blockConsumption4: [100, 9999], // Corrected to use an array of numbers
  ...
  const expandableConfig = {
    expandedRowRender: (record: DataSourceType) => {
      ...
      const config = {
        ...
        color: [theme.red, theme.orange], // Specify the colors for each series
      };
