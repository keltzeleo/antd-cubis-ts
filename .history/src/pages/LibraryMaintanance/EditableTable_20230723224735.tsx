...
const EditableTable: React.FC<EditableTableProps> = ({ theme }) => {
  ...
  const columns: ProColumns<DataSourceType>[] = [
    ...
    },
    {
      ...
      valueType: "date",
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>{record.created_at}</span>
      ),
    },
    {
    ...
    },
    {
      ...
      width: "100",
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>{record.ratespercubicm1}</span>
      ),
    },
    {
    ...
    },
    {
      ...
      width: "100",
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>{record.ratespercubicm2}</span>
      ),
    },
    {
