      ...
      <Row gutter={16}>
        {record.nestedData.map((nestedItem, index) => (
          <Col span={8} key={nestedItem.key}>
            <ProCard bordered title={`0${index + 1}`}>
              <div>
                <p>
                  <strong>Effective Date:</strong> {nestedItem.effectiveDate} | {index + 1}
                </p>
                <div>
                  <p>
                ...
                {showAdditionalColumns && (
                  <div>
                    <p>
                      <strong>Created By:</strong> {nestedItem.createdBy}
                    </p>
                    <p>
                      <strong>Create Date:</strong> {nestedItem.createDate}
                    </p>
                    <p>
                      <strong>Modified By:</strong> {nestedItem.modifiedBy}
                    </p>
                    <p>
                      <strong>Modified Date:</strong> {nestedItem.modifiedDate}
                    </p>
                  </div>
                )}
              </ProCard>
