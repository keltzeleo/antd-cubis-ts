          ...
          {record.nestedData.map((nestedItem) => (
            <Col span={8} key={nestedItem.key}>
              ...
              >
                ...
                <ProCard.Meta
                  title="Effective Date"
                  description={nestedItem.effectiveDate}
                />
                {showAdditionalColumns && (
                  <>
                    <ProCard.Meta
                      title="Created By"
                      description={nestedItem.createdBy}
                    />
                    <ProCard.Meta
                      title="Create Date"
                      description={nestedItem.createDate}
                    />
                    <ProCard.Meta
                      title="Modified By"
                      description={nestedItem.modifiedBy}
                    />
                    <ProCard.Meta
                      title="Modified Date"
                      description={nestedItem.modifiedDate}
                    />
                  </>
                )}
              </ProCard>
