          ...
          editable={{
            ...
            actionRender: (row, config, dom) => [
              <Popconfirm
                ...
                onConfirm={() => {
                  dom?.save?.(); // Use the optional chaining operator and the nullish coalescing operator
                }}
              ...
              <Popconfirm
                ...
                onConfirm={() => {
                  dom?.cancel?.(); // Use the optional chaining operator and the nullish coalescing operator
                }}
              ...
              <Popconfirm
                ...
                onConfirm={() => {
                  dom?.delete?.(); // Use the optional chaining operator and the nullish coalescing operator
                }}
