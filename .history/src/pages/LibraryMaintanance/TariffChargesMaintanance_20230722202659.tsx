      ...
      title: (
        <div
          style={{
            ...
            height: "100%",
            width: 120,
            background: "rgba(0, 0, 0, 0.2)", // Semi-transparent overlay color for the blur effect
            zIndex: 1,
            borderRadius: 8, // Ensure the overlay is behind the content
            backdropFilter: "blur(10px)", // Use backdrop-filter for modern browsers that support it
          }}
        >
          &nbsp; Actions &nbsp;&nbsp;&nbsp;&nbsp;{" "}
        </div>
