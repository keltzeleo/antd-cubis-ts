...
const TariffChargesMaintenance2: React.FC<EditableTableProps> = ({ theme }) => {
  ...
  const handleSave = async (rowKey: React.Key) => {
    // Implement the logic to save the changes for the record with the given rowKey
    // You can use the data from dataSource to save the changes
    console.log(`Save record with rowKey: ${rowKey}`);
  };

  const handleCancel = async (rowKey: React.Key) => {
    // Implement the logic to cancel the changes for the record with the given rowKey
    // You can use the data from dataSource to revert the changes
    console.log(`Cancel changes for record with rowKey: ${rowKey}`);
  };

  const handleDelete = async (rowKey: React.Key) => {
    // Implement the logic to delete the record with the given rowKey
    // You can use the data from dataSource to find and remove the record
    setDataSource((prevDataSource) =>
      prevDataSource.filter((item) => item.id !== rowKey)
    );
    console.log(`Delete record with rowKey: ${rowKey}`);
  };
  ...
  const columns: ProColumns<DataSourceType>[] = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>
          RM {record.monthlyMinimumCharges}
        </span>
      ),
    },
...

    {
      ...
      valueType: "digitRange", // Use the custom valueType here
      width: "auto",
      hideInTable: !showBlockConsumptionsRates,
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>
          {record.ratespercubicm1 && `RM ${record.ratespercubicm1}/m³`}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (text, record) => (
        ...
        >
          {" "}
          {record.ratespercubicm2 && `RM ${record.ratespercubicm2}/m³`}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>
          {record.ratespercubicm3 && `RM ${record.ratespercubicm3}/m³`}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>
          {record.ratespercubicm4 && `RM ${record.ratespercubicm4}/m³`}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>
          {record.ratespercubicm5 && `RM ${record.ratespercubicm5}/m³`}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>
          {record.ratespercubicm6 && `RM ${record.ratespercubicm6}/m³`}
        </span>
      ),
    },

    {
      ...
      key: "createdBy",
      readonly: true,
      hideInTable: !showAdditionalColumns, // Step 4: Hide column based on the state
    ...
    },
    {
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>{record.createdDate}</span>
      ),
    },
    {
      title: "Modified By",
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>{record.modifiedBy}</span>
      ),
    },
    {
      title: "Modified Date",
      ...
      render: (text, record) => (
        <span style={{ color: theme.colorText }}>{record.modifiedDate}</span>
      ),
    },
