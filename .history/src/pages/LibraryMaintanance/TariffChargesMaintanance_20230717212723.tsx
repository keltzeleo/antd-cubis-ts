...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
          ...
          const updatedRecord = {
            ...
            nestedData: record.nestedData?.map((nestedItem) => {
              ...
              return {
                ...
                ...(matchingItem || {}),
                isEditing: false,
                rate: matchingItem?.rate || nestedItem.rate,
              };
            }),
            effectiveDate: {
  ...
  const nestedColumns: ProColumns<NestedDataType>[] = [
      ...
      : []),
    {
      ...
      fixed: "right",
      width: 120,
      render: (_, nestedRecord, nestedIndex) => {
        ...
        return (
          <Space>
            <Button
              type="primary"
              onClick={() =>
                handleEdit(nestedRecord.key, record as TariffChargesDataType)
              }
            >
              Edit
            </Button>
                    ...
                    expandedRowRender={(nestedRecord) =>
                      nestedRecord.isEditing ? (
                        <Space>
                          ...
                          <Button
                            onClick={(record) => handleCancel(record.key)}
                          >
                            Cancel
                          </Button>
                          ...
                          <Button
                            onClick={(record) =>
                              handleDelete(nestedRecord, record)
                            }
                          >
                            Delete
                          </Button>
