...
import { ProFormDigit, ProFormDigitRange } from "@ant-design/pro-components";
...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  const [dataSource, setDataSource] =
    useState<TariffChargesDataType[]>(initialDataSource);
  ...
  const nestedColumns: ProColumns<NestedDataType>[] = [
    ...
    },
    {
      ...
      renderFormItem: (item, { isEditable, record }, formInstance) => {
        if (isEditable) {
          return <ProFormDatePicker name="effectiveDate" format="DD/MM/YYYY" />;
        }
        return item.text;
      },
    },
