  ...
  const columns: ProColumns<TariffChargesDataType, "text">[] = [
    ...
    },
    {
      ...
      render: (text: any, record: TariffChargesDataType) =>
        record.nestedData?.[0]?.blockConsumption1,
    },
    {
      title: "Rate 1",
      dataIndex: "nestedData",
    ...
    },
    {
      ...
      valueType: "digitRange",
      render: (text: any, record: TariffChargesDataType) =>
        record.nestedData?.[0]?.blockConsumption2,
    },
    {
      title: "Rate 2",
      dataIndex: "nestedData",
    ...
    },
    {
      ...
      valueType: "digitRange",
      render: (text: any, record: TariffChargesDataType) =>
        record.nestedData?.[0]?.blockConsumption3,
    },
    {
      title: "Rate 3",
      dataIndex: "nestedData",
    ...
    },
    {
      ...
      valueType: "digitRange",
      render: (text: any, record: TariffChargesDataType) =>
        record.nestedData?.[0]?.blockConsumption4,
    },
    {
      title: "Rate 4",
      dataIndex: "nestedData",
    ...
    },
    {
      ...
      valueType: "digitRange",
      render: (text: any, record: TariffChargesDataType) =>
        record.nestedData?.[0]?.blockConsumption5,
    },
    {
      title: "Rate 5",
      dataIndex: "nestedData",
    ...
    },
    {
      ...
      valueType: "digitRange",
      render: (text: any, record: TariffChargesDataType) =>
        record.nestedData?.[0]?.blockConsumption6,
    },
    {
      title: "Rate 6",
      dataIndex: "nestedData",
    ...
    },
    {
      ...
      render: (text, record: TariffChargesDataType, _: any, action: any) => [
        <a
          key="editable"
          onClick={() => {
