...
type TariffChargesDataType = {
  ...
  blockConsumption2: Tuple | null;
  blockConsumption3: Tuple | null;
  blockConsumption4: Tuple | null;
  blockConsumption5: Tuple | null;
  blockConsumption6: Tuple | null;
  rate1: number | null;
  rate2: number | null;
  rate3: number | null;
  rate4: number | null;
...
const convertDataForChart = (data: TariffChargesDataType) => {
  const chartData: {
    ...
    <>
      <Form form={formRef.current}>
        <ProTable<TariffChargesDataType>
          ...
          bordered={true}
          expandable={expandableConfig} // Add the expandable configuration here
        />
      </Form>
    </>
  );
