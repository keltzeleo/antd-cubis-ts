            ...
            <Row gutter={16}>
              {record.nestedData.map((nestedItem, index) => (
                <Col span={8} key={nestedItem.key}>
                  <ProCard title={`0${index + 1}`}>
                    <div>
                      <p><strong>Block:</strong> {nestedItem.block}</p>
                      <p><strong>Rate:</strong> {nestedItem.rate}</p>
                      <p><strong>Effective Date:</strong> {nestedItem.effectiveDate}</p>
                    </div>
                    {showAdditionalColumns && (
                      <div>
                        <p><strong>Created By:</strong> {nestedItem.createdBy}</p>
                        <p><strong>Create Date:</strong> {nestedItem.createDate}</p>
                        <p><strong>Modified By:</strong> {nestedItem.modifiedBy}</p>
                        <p><strong>Modified Date:</strong> {nestedItem.modifiedDate}</p>
                      </div>
                    )}
                  </ProCard>
                </Col>
                ...
                <Col span={8}>
                  <ProCard bordered>
                    <div style={{ textAlign: 'center' }}>
                      <Button type="primary" shape="circle" icon={<PlusCircleFilled />} />
                    </div>
                  </ProCard>
                </Col>
              )}
