      ...
      render: (_, record) => (
        <Space style={{ justifyContent: "space-evenly", width: "100%" }}>
          <Button
            type="primary"
            icon={<EditOutlined />}
            onClick={() => handleEdit(record.nestedData[0])} // Assuming you want to edit the first nested data item
          >
            Edit
          </Button>
          <Button
            ...
            danger
            icon={<DeleteOutlined />}
            onClick={() => handleDelete(record.nestedData[0])} // Assuming you want to delete the first nested data item
          >
            Delete
          </Button>
        </Space>
