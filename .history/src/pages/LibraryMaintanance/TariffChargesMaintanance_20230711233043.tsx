...
import { Row, Col, Space, DatePicker, Input, Button } from 'antd';
...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  const handleAddBlock = () => {
    // Add logic here to handle adding a new block
  };
    ...
    <ProCard>
      <Row gutter={16}>
        {record.nestedData.map((nestedItem, index) => (
          <Col key={nestedItem.key} style={{ marginRight: 16 }}>
            <ProCard split="vertical" bordered>
              <ProCard title={`0${index + 1}`} colSpan="50px"></ProCard>
              <ProCard
                title={
                  <p style={{ margin: 0 }}>
