...
import ActionsColumn from "./ActionsColumn"; // Adjust the import path based on your project structure
...
// Export the DataSourceType interface separately
export interface DataSourceType {
  ...
  // (Include all the properties of DataSourceType here)
}
