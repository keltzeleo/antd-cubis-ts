...
nope.. i dont see the nested table is doing the same thing as main table when the save button is clicked, is it possible to let the save button from main table to act as the save button for both main and nested?