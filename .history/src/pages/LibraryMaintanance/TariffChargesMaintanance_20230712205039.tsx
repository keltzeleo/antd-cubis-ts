...
interface NestedDataType {
  ...
  rate: number | null;
  effectiveDate: Dayjs | null; // Updated type declaration
  createdBy: string;
  createDate: string;
  modifiedBy: string;
  modifiedDate: string;
      ...
      nestedData: [
        {
          ...
          block: [0, 10],
          rate: 0.03,
          effectiveDate: dayjs("04/07/2020", "DD/MM/YYYY"),
          createdBy: "John Doe",
          createDate: "2023-07-01",
          modifiedBy: "John Doe",
          modifiedDate: "2023-07-01",
        },
        {
          ...
          block: [11, 20],
          rate: 0.08,
          effectiveDate: dayjs("04/07/2023", "DD/MM/YYYY"),
          createdBy: "John Doe",
          createDate: "2023-07-01",
          modifiedBy: "John Doe",
          modifiedDate: "2023-07-01",
        },
        {
          ...
          block: [21, 100],
          rate: 0.13,
          effectiveDate: dayjs("04/07/2024", "DD/MM/YYYY"),
          createdBy: "John Doe",
          createDate: "2023-07-01",
          modifiedBy: "John Doe",
          modifiedDate: "2023-07-01",
