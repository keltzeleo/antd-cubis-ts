...
const EditableTable: React.FC<EditableTableProps> = ({ theme }) => {
  ...
  const columns: ProColumns<DataSourceType>[] = [
...

    {
      ...
      fixed: "right",
      width: "138",
      render: (text: any, record: DataSourceType, _, action) => actionsColumn, // Use the memoized actionsColumn here
          <a
            key="editable"
            onClick={() => {
              action?.startEditable?.(record.id);
  ...
  return (
    <>
      <EditableProTable<DataSourceType>
        ...
        rowClassName={() => "editable-cell"} // Apply the CSS class to each row
