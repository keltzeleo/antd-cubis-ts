...
const TariffChargesMaintenance: React.FC<TariffChargesMaintenanceProps> = ({
  ...
  const columns: ProColumns<TariffChargesDataType>[] = [
      ...
      : []),
    {
      ...
      width: 120,
      style: {
        backgroundColor: "lightblue", // Background color for the column header and cells
        color: "white", // Text color for the column header and cells
        fontWeight: "bold", // Font weight for the column header and cells
      }, // Apply the blurry-actions class here
