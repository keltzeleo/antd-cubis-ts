    ...
    },
    {
      ...
      render: () => (
        <Select
          ...
          onChange={(value: string) => setNewMeterLocation(value)}
        >
    ...
    },
    {
      ...
      render: () => (
        <Input
          ...
          onChange={(e) => {
            // Use a regular expression to ensure only digits are entered
            const sanitizedValue = e.target.value.replace(/\D/g, "");
            setInitialReading(sanitizedValue);
          }}
        />
      ),
    },
