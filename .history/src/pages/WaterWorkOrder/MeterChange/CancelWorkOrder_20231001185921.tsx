...
const CancelWorkOrder: React.FC<CancelWorkOrderProps> = ({ theme }) => {
  ...
  const [cancelWorkOrderStatus, setCancelWorkOrderStatus] = useState("");
      ...
      <Form form={form} layout="vertical" onFinish={handleSubmit}>
        ...
        <Row gutter={16} style={{ paddingLeft: 16, marginTop: 16 }}>
          ...
          <Col span={18} style={{ marginLeft: 16, alignContent: "center" }}>
            ...
            <Form.Item label="Cancel Work Order">
              <Select
                value={cancelWorkOrderStatus}
                onChange={(option) => setCancelWorkOrderStatus(option.label)}
              >
                <Option value="Option1">Cancel Reason 1</Option>
                <Option value="Option2">Cancel Reason 2</Option>
              ...
              <Row gutter={16}>
                ...
                <Col span={8}>
                  <Form.Item label="Work Order Status">
                    ...
                    >
                      <span>{cancelWorkOrderStatus}</span>{" "}
                    </span>
                  </Form.Item>
                </Col>
              </Row>
