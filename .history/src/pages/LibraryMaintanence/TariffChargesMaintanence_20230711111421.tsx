...
const columns = [
  ...
  },
  {
    ...
    render: (_: any, record: any) => (
      <a onClick={() => handleExpand(!isExpanded(record.key), record)}>
        {isExpanded(record.key) ? "Collapse" : "Expand"}
      </a>
    ),
  },
  {
    ...
    return (
      <>
        ...
        <div>
          ...
          <p>Created Date: {record.createdDate}</p>
          <p>Modified By: {record.modifiedBy}</p>
          <p>Modified Date: {record.modifiedDate}</p>
        </div>
        ...
        <ProTable
          ...
          pagination={false}
          headerTitle={false}
          size="small" // Add this line to adjust the size of the nested table
        />
