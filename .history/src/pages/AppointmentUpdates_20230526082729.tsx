...

      {
        ...
        filterDropdown: ({
          ...
          >
            ...
            {/* Make sure to set the selectedKeys and call confirm/clearFilters as needed */}
          </div>
        ),
        filterDropdownVisible: true, // Set to true to display the filter dropdown by default
        getPopupContainer: () =>
          document.getElementsByClassName("ant-table-content")[0], // Append dropdown menu to the Table component
      },
      {
        title: "Action",
        dataIndex: "action",
