...
const DragDropArea2: React.FC = () => {
  ...
  return (
    <div className="drag-drop-container">
      ...
      <div className="left-section" style={{ display: "flex", flexDirection: "column" }}>
  <div style={{ width: "220px", marginBottom: "16px" }}>
    <IdTypeBoard selectedOption={selectedIdType} />
  </div>
  <div className="upload-area" style={{ width: "250px", height: "450px" }}>
    <Dragger
          ...
          <div style={{ flex: 1, height: "auto" }}>
            ...
            >
              <div
                ...
                style={{
                  display: "flex",
                  flexDirection: "row", // Reversed direction
