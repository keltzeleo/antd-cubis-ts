    ...
    >
      ...
      <p
        style={{
          ...
          fontSize: fileList.length >= 8 ? "16px" : "initial", // Increase font size when full
          fontWeight: fileList.length >= 8 ? "bold" : "normal", // Increase font weight when full
        }}
      >
        {fileList.length >= 8 ? (
          <span style={{ fontSize: "28px" }}>Full</span>
        ) : (
          fileCounter
        )}
      </p>
