...
const DragDropArea2: React.FC<DragDropArea2Props> = ({ theme }) => {
  ...
  const [customerInfoHeight, setCustomerInfoHeight] = useState(0);

  useEffect(() => {
    if (rightSectionRef.current) {
      const width = rightSectionRef.current.offsetWidth;
      setCustomerInfoHeight(height);
    }
  }, []);
      ...
      <div className="content-container" style={{ display: "flex" }}>
        ...
        <div
          ...
          style={{
            ...
            flex: 1,
            maxHeight: `calc(100vh - ${customerInfoHeight}px)`, // Adjust the calculation as needed
            overflowY: "auto",
          }}
        >
          &nbsp;
