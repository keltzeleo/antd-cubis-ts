...
const AppointmentUpdates: React.FC = () => {
  const [theme, setTheme] = useState(light); // Initialize the theme state with the theme theme

  // Function to toggle the theme
  const toggleTheme = () => {
    const newTheme = theme === light ? dark : theme;
    setTheme(newTheme);
    ...
    const tags = [
      { value: "assigned", label: "Assigned", color: theme["cyan"] },
      { value: "cancelled", label: "Cancelled", color: theme["red"] },
      {
        value: "failed to visit",
        label: "Failed to Visit",
        color: theme["orange"],
      },
      { value: "reassigning", label: "Reassigning", color: theme["geekblue"] },
      { value: "rescheduled", label: "Rescheduled", color: theme["lime"] },
    ];
            ...
            <>
              ...
              >
                ...
                <Tag
                  color={theme["geekblue"]}
                  onClick={() =>
                    handleTagFilterMaster(StatusLabels.REASSIGNING)
                  }
                  style={{
                    borderRadius: 8,
                    height: "auto",
                ...
                <Tag
                  color={theme["lime"]}
                  onClick={() =>
                    handleTagFilterMaster(StatusLabels.RESCHEDULED)
                  }
                  style={{
                    borderRadius: 8,
                    height: "auto",
    ...
    return (
      <ConfigProvider theme={{ token: theme }}>
        <div style={{ background: "", margin: "8px 8px" }}>
          ...
          >
            ...
            <Switch
              checked={JSON.stringify(theme) === JSON.stringify(dark)}
          ...
          <>
            ...
            {searchValue && searchResults.length > 0 && (
              <List
                style={{ marginTop: -10, background: "colorPrimaryBg" }}
                bordered
                ...
                renderItem={(item) => (
                  <List.Item>
                    <div style={{ display: "flex", alignItems: "center" }}>
                      ...
                      <span style={{ marginLeft: 8, paddingTop: 6 }}>
                        {item.name}
                      </span>
                    </div>
                  </List.Item>
