...
import DragDropArea2 from "../DragDropArea/DragDropArea2";
...
const AppointmentUpdates: React.FC<{ theme: any }> = ({ theme }) => {
    ...
    const nestedColumns = [
      {
        ...
        render: (text: string) => (
          <span
            style={{
              color: theme.token.colorTextBase, // Apply font color styling based on the selected theme
            }}
          >
            {text}
          </span>
        ), // Apply font color styling based on the selected theme
