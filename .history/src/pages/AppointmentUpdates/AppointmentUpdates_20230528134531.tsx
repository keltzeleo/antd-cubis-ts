...
const AppointmentUpdates: React.FC = () => {
  ...
  /**
   * handleTagChange updates the selected tags and applies the filter to all nested tables.
   * @param tagValue - The selected tags.
   */
  ...
  const [selectedTags, setSelectedTags] = useState<StatusLabels[]>([]);
