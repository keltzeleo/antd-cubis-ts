    ...
    const nestedColumns = [
...

      {
        ...
        render: (status: string) => {
          ...
          const theme = prefixCls === "ant-tag" ? "light" : "dark";
          let color = "";
          switch (status) {
            case "assigned":
              color = theme === "light" ? light["cyan"] : dark["cyan"];
              break;
            case "cancelled":
              color = theme === "light" ? light["red"] : dark["red"];
              break;
            case "failed to visit":
              color = theme === "light" ? light["orange"] : dark["orange"];
              break;
            case "reassigning":
              color = theme === "light" ? light["geekblue"] : dark["geekblue"];
              break;
            case "rescheduled":
              color = theme === "light" ? light["lime"] : dark["lime"];
              break;
            default:
              break;
          }
