            ...
            >
              <Tag
                ...
                style={{
                  ...
                  color: statusFilters[record.key]?.includes(StatusLabels.ASSIGNED)
                    ? "white"
                  ...
                  backgroundColor: statusFilters[record.key]?.includes(
                    ...
                    ? light["cyan"]
                    : undefined,
                  borderColor: statusFilters[record.key]?.includes(StatusLabels.ASSIGNED)
                    ? light["cyan"]
                    : light["colorTextDisabled"],
                  cursor: "pointer",
                }}
              >
                <span
                  style={{
                    ...
                    background: statusFilters[record.key]?.includes(StatusLabels.ASSIGNED)
                      ? "#fff"
                      : undefined,
                    borderRadius: "50%",
                    width: 16,
              ...
              <Tag
                color={light["red"]}
                onClick={() => handleTagFilter(StatusLabels.CANCELLED, record.key)}
                style={{
                  borderRadius: 8,
                  height: "auto",
                  padding: "2 8 2 8",

                  color: statusFilters[record.key]?.includes(StatusLabels.CANCELLED)
                    ? "white"
                    : light["colorTextDisabled"],
                  backgroundColor: statusFilters[record.key]?.includes(
                    StatusLabels.CANCELLED
                    ...
                    ? light["red"]
                    : undefined,
                  borderColor: statusFilters[record.key]?.includes(StatusLabels.CANCELLED)
                    ? light["red"]
                    : light["colorTextDisabled"],
                  cursor: "pointer",
                }}
              >
                <span
                  style={{
                    ...
                    alignItems: "center",
                    justifyContent: "center",
                    background: statusFilters[record.key]?.includes(StatusLabels.CANCELLED)
                      ? "#fff"
                      : undefined,
                    borderRadius: "50%",
                    width: 16,
              ...
              <Tag
                color={light["orange"]}
                onClick={() => handleTagFilter(StatusLabels.FAILED_TO_VISIT, record.key)}
                style={{
                  borderRadius: 8,
                  height: "auto",
                  padding: "2 8 2 8",

                  color: statusFilters[record.key]?.includes(StatusLabels.FAILED_TO_VISIT)
                    ? "white"
                    : light["colorTextDisabled"],
                  backgroundColor: statusFilters[record.key]?.includes(
                    StatusLabels.FAILED_TO_VISIT
              ...
              <Tag
                color={light["geekblue"]}
                onClick={() => handleTagFilter(StatusLabels.REASSIGNING, record.key)}
                style={{
                  borderRadius: 8,
                  height: "auto",
                  padding: "2 8 2 8",

                  color: statusFilters[record.key]?.includes(StatusLabels.REASSIGNING)
                    ? "white"
                    : light["colorTextDisabled"],
                  backgroundColor: statusFilters[record.key]?.includes(
                    StatusLabels.REASSIGNING
              ...
              <Tag
                color={light["lime"]}
                onClick={() => handleTagFilter(StatusLabels.RESCHEDULED, record.key)}
                style={{
                  borderRadius: 8,
                  height: "auto",
                  padding: "2 8 2 8",

                  color: statusFilters[record.key]?.includes(StatusLabels.RESCHEDULED)
                    ? "white"
                    : light["colorTextDisabled"],
                  backgroundColor: statusFilters[record.key]?.includes(
                    StatusLabels.RESCHEDULED
