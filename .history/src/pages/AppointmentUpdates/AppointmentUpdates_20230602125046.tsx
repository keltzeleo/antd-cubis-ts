    ...
    const nestedColumns = [
...

      {
        ...
        render: (status: string) => {
          ...
          switch (status) {
            case "assigned":
              color = theme === "light" ? dark["cyan"] : dark["cyan"];
              break;
            case "cancelled":
              color = theme === "light" ? dark["red"] : dark["red"];
              break;
            case "failed to visit":
              color = theme === "light" ? dark["orange"] : dark["orange"];
              break;
            case "reassigning":
              color = theme === "light" ? dark["geekblue"] : dark["geekblue"];
              break;
            case "rescheduled":
              color = theme === "light" ? dark["lime"] : dark["lime"];
              break;
            default:
              break;
          }
