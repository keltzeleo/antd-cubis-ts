...
type FormProps =
  ...
  | PlanApprovalInfoFormProps
  | SiteInspectionApprovalFormProps
  | GetNeighbourAccountFormProps
  | BillPaymentApprovalFormProps
  | ConnectionApprovalFormProps
  | IssueDepositAndInstallationBillFormProps
  | CompleteMeterInstallationFormProps;
