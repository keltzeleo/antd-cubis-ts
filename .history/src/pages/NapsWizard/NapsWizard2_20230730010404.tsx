...
import PlanApprovalInfoForm, {
  PlanApprovalInfoFormProps,
} from "../Forms/PlanApprovalInfoForm";
...
type FormProps = SiteVisitApprovalFormProps | PlanApprovalInfoFormProps;
// Add other form props here as needed
