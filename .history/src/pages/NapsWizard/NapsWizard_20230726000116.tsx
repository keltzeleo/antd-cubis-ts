  ...
  return (
    <>
      ...
      >
        ...
        <StepsForm.StepForm
          name="base"
          title={<span className={circleIconClass}>1</span>} // Add the circle icon for step 1
          onFinish={async () => {
            await waitTime(2000);
            return true;
          }}
        ...
        <StepsForm.StepForm
          name="checkbox"
          title={<span className={circleIconClass}>2</span>} // Add the circle icon for step 2
        >
          <ProCard
            style={{
              minWidth: 800,
        ...
        <StepsForm.StepForm
          name="time"
          title={<span className={circleIconClass}>3</span>} // Add the circle icon for step 3
        >
          <ProCard
            style={{
              marginBlockEnd: 16,
