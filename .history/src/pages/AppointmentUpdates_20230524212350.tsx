...
const AppointmentUpdates: React.FC = () => {
  ...
  const [addAppointmentData, setAddAppointmentData] = useState<Plumber | null>(
    null
  ); // State for Add Appointment drawer data
  ...
  const handleAddAppointment = (data: Plumber) => {
    setAddAppointmentData(data); // Set the data for the Add Appointment drawer
    setAddAppointmentVisible(true);
  };

  const closeAddAppointmentDrawer = () => {
    setAddAppointmentVisible(false);
    setAddAppointmentData(null); // Clear the Add Appointment drawer data
  };
