...
const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({ theme }) => {
  ...
  const renderSingleRowCalendar = (
    ...
    setDoubleClickedDate: React.Dispatch<React.SetStateAction<Dayjs | null>> // Add the setDoubleClickedDate prop
  ) => {
                  ...
                  {Array.from({ length: monthDaysInMonth }, (_, dayIndex) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() => handleSingleRowDateDoubleClick(date)} // Handle double-click on the date cell
                        onDoubleClick={() => handleDateCellDoubleClick(date)} // Handle single-click on the date cell
                      >
                        {date.format("D")}
                      </div>
                    );
