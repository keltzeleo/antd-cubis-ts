...
const TableTransfer = ({
  ...
  >
    {({
      ...
      const columns = direction === "right" ? leftColumns : rightColumns;
...
const TransferSample: React.FC<TransferSampleProps> = ({
  ...
  const firstColumn = leftTableColumns.shift() ?? {}; // Provide an empty object if the array is empty
  leftTableColumns.push(firstColumn);
