  ...
  >
    {({
      ...
      const rowSelection = {
        ...
        fixed: direction === "left" ? "right" : "left", // Set "right" for leftTableColumns and "left" for rightTableColumns
        // The `fixed` property above will determine whether the checkbox column is fixed to the left or right of the table
      };
