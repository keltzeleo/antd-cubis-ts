                  ...
                  {Array.from({ length: monthDaysInMonth }, (_, dayIndex) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {date.format("D")}
                        {console.log("Value of showTransfer:", showTransfer)}
{console.log("Value of isHighlighted for date", date.format("DD-MM-YYYY"), ":", isHighlighted)}
{console.log("Value of isHighlightedRightColumn for date", date.format("DD-MM-YYYY"), ":", isHighlightedRightColumn)}
