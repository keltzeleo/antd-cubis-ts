...
const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({ theme }) => {
  ...
  const cellRender = (current: Dayjs, info: CellRenderInfo<Dayjs>) => {
    ...
    // Custom styling for Saturdays and Sundays
    if (current.day() === 0 || current.day() === 6) {
      return (
        <div className="ant-picker-cell-inner ant-picker-cell-in-view">
          <div className="ant-picker-cell-inner-content ant-picker-cell-date">
            <span className="ant-picker-cell-day">
    ...
    // For other days, return the default cell rendering
