...
const dateCellRender = (date: Dayjs) => {
  ...
  return (
    ...
    {isHoliday && (
      <div style={{color: theme.colorTextSecondary, backgroundColor: theme["geekblue.4"], marginBottom: 5, borderRadius: 8, paddingLeft: 8, fontSize: 10, fontWeight: 600, }}>
        Holiday:{holidayName}
      </div>
    )}
...
const onDragEnd = (result: DropResult) => {
  ...
  // Check if the book is dropped in a different date
