...
const TableTransfer = ({
  ...
  >
    {({
      ...
      const columns: Column<DataType>[] = direction === "left" ? leftColumns : rightColumns;

      if (direction === "left") {
        const firstColumn = columns.shift() as Column<DataType>;
      ...
      return (
        ...
        columns={columns} {/* Use the columns for the table */}
