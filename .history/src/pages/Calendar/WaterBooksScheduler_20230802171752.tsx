...
{
  '02-08-2023': [
    { type: 'warning', content: 'This is warning event.' , backgroundColor: theme['yellow.3'], borderRadius:8},
                ...
                <Draggable key={item.content} draggableId={item.content} index={index}>
                  {(provided) => (
                    <li
                      ...
                      style={{ fontSize: 14,borderRadius:12, fontWeight: 600, backgroundColor: item.backgroundColor || 'transparent' }}
