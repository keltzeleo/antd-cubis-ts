...
const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({ theme }) => {
 ...
 // Check if it's Sunday (0) or Saturday (6) and apply custom style accordingly
 const dayOfWeek = current.day();
 const customStyle = {
   backgroundColor: (dayOfWeek === 0 || dayOfWeek === 6) ? 'red' : 'inherit',
 };

 return (
   <div className="ant-picker-cell" role="gridcell" style={customStyle}>
     {info.originNode}
   </div>
 );
};
