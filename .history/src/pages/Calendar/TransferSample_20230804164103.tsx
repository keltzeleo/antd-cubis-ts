...
const TransferSample: React.FC<TransferSampleProps> = ({ theme }) => {
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        <div
          style={{
            ...
            overflow: "hidden",
            color: "#ffffff",
            margin: "8 8 0 0", // Added margin to create space between the two sections
          }}
        >
          <div
            style={{
      ...
      <div>
        <div style={{ marginBottom: 16, fontWeight: "bold" }}>Left Table</div>
        <TableTransfer
          dataSource={mockData}
      ...
      {/* Title and Table for the right table */}
      <div style={{ marginTop: 16 }}>
        ...
        <TableTransfer
          ...
          leftColumns={rightTableColumns} // Use the rightTableColumns for the right table
          rightColumns={leftTableColumns} // Use the leftTableColumns for the right table
        />
      </div>
    </>
  );
