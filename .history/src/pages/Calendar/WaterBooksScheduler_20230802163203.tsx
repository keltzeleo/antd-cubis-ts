...
const isMalaysiaHoliday = (date: Dayjs) => {
 ...
 const holidayName = holidays2023.find((holiday) => holiday.date === date.format('DD-MM-YYYY'))?.name;
    ...
    return (
      <ul className="events">
        ...
        {isHoliday && (
          <div style={{color: theme.colorTextSecondary, backgroundColor: theme["geekblue.3"], marginBottom: 5, borderRadius: 8, paddingLeft: 8,  }}>
            Holiday:{holidayName}
          </div>
        )}
