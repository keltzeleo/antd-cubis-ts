        ...
        <Droppable droppableId={`dateCell_${dateKey}`} isDropDisabled={false}>
          {(provided) => (
            ...
            >
              ...
              <div // Add the onDoubleClick event handler to this div element
                onDoubleClick={handleDatePanelDoubleClick}
        ...
        <div>
          ...
          {showSingleRow ? (
            ...
            <Calendar
              ...
              onPanelChange={onPanelChange} // Use onPanelChange to handle double-click event
