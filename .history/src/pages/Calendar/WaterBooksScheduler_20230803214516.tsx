          ...
          {Array.from({ length: numMonthsToShow }, (_, monthIndex) => {
            ...
            return (
              ...
              if (isWeekend) {
                ...
                backgroundColor = theme["yellow.legend"]; // Use the background color of the "Scheduled" legend item
              }

                // Set the background color based on whether it's a rest day, holiday, scheduled, or unscheduled day
                let colorText = "transparent";
                if (isWeekend) {
                  colorText = theme["red.2"];
                } else if (isHoliday) {
                  colorText = theme["geekblue.3"];
                } else if (hasScheduledEvents) {
                  colorText = theme["yellow"]; // Use the background color of the "Scheduled" legend item
                }
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        border: "none", // Remove the border from each day column
