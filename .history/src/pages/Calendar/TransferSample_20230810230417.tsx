...
interface TableTransferProps extends TransferProps<DataType> {
  ...
  handleRightTableColumnDateChange: Dayjs | null; // Add handleRightTableColumnDateChange prop
}
  ...
  return (
    <>
      ...
      <TableTransfer
        ...
        setSelectedRightTableColumnDate={handleRightTableColumnDateChange} // Pass the selectedRightTableColumnDate as a prop
      />
    </>
  );
};
