...
const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({ theme }) => {
  ...
  const renderSingleRowCalendar = (
    ...
    selectedRightTableColumnDate: (date: Dayjs) => void | null, // Receive selectedRightTableColumnDate as a prop
    handleRightTableColumnDateChange: Dayjs | null
  ) => {
                  ...
                  {Array.from({ length: monthDaysInMonth }, (_, dayIndex) => {
                    ...
                    const isHighlightedRightColumn =
                      handleRightTableColumnDateChange
                        ? date.isSame(handleRightTableColumnDateChange, "day")
                        : false;
                    ...
                    return (
                      ...
                      >
                        <div>
                          {handleRightTableColumnDateChange && (
                            <span>
                              Date Selected: {setSelectedRightTableColumnDate}
                            </span>
                          )}
                        </div>{" "}
                        {""}
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          {showSingleRow ? (
            renderSingleRowCalendar(
              selectedDate,
              handleDateSelect,
              setSelectedRightTableColumnDate, // Pass selectedRightTableColumnDate here
