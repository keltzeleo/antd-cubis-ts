...
const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({ theme }) => {
  ...
  // Add the handleRightTableColumnDateChange function here
  const handleRightTableColumnDateChange = (date: Dayjs | null) => {
    setSelectedRightTableColumnDate(date);
    setSelectedRightTableColumn(1); // Set the selectedRightTableColumn to 1 when choosing a date in the ProFormDatePicker
  };
