...
const renderSingleRowCalendar = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row" }}>
      {/* Render empty placeholders for days before the first day of the current month */}
      ...
      {Array.from({ length: daysInMonth }, (_, index) => {
        ...
        return (
          <React.Fragment key={index}>
            {/* Render the month name in the additional column for the first day of each month */}
            {date.date() === 1 && (
              <div
                style={{
                  flex: 1,
