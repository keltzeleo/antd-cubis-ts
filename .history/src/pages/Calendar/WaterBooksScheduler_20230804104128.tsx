...
const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({ theme }) => {
  ...
  const renderSingleRowCalendar = (
    ...
    const renderSingleRowCalendar = (
      ...
      // ... (The existing code for the function with the modifications)
      // ... (Please refer to the previous answer for the full code)
      ...
      const handleSingleRowDateSelect = (date: Dayjs) => {
        ...
        // Call the provided handleDateSelect function if it is available
        if (handleDateSelect) {
