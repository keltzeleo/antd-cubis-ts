...
const TransferSample: React.FC<TransferSampleProps> = ({
  ...
  const localHandleRightTableColumnDateChange = (date) => {
    console.log(
  ...
  return (
    <>
      ...
      <TableTransfer
        ...
        handleRightTableColumnDateChange={localHandleRightTableColumnDateChange} // Pass the handleRightTableColumnDateChange function
      />
    </>
  );
};
