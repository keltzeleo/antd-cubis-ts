    ...
    <DragDropContext onDragEnd={onDragEnd}>
      <div>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          {showSingleRow ? (
            renderSingleRowCalendar(selectedDate, handleDateSelect, selectedRightTableColumnDate)
          ) : (
            <Calendar
              value={value}
              onSelect={(date) => {
          ...
          <div style={{ margin: 32 }}>
            {showTransfer && (
              ...
              <TransferSample
                ...
                setSelectedRightTableColumnDate= (date: Dayjs | null) =>
                void // Use doubleClickedDate instead of doubleClickDate
              />
            )}
          </div>
          <Drawer
