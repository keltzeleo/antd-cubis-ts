...
const TableTransfer = ({
  ...
  >
    {({
      ...
      // Create a copy of columns so that we can modify it for the left table
      const modifiedColumns = [...columns];

      // If the direction is left, move the first column (ant-table-selection-column) to the end
      if (direction === "left") {
        const firstColumn = modifiedColumns.shift();
        modifiedColumns.push(firstColumn);
      }
