              ...
              return (
                <React.Fragment key={`month_${monthIndex}`}>
                  ...
                  {Array.from({ length: monthDaysInMonth }, (_, dayIndex) => {
                    ...
                    let colorText = "transparent"; // Set a default font color (use the text color from the theme)
                    ...
                    if (isHighlighted) {
                      ...
                      colorText = theme["colorText"]; // Change this to your desired highlight color
                    }
