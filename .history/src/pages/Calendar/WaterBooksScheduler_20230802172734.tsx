...
const mockScheduledBooks: Record<string, { type: string; content: string;backgroundColor?: string; borderRadius?: number;  }[]> =
{
  '03-08-2023': [
  ...
  const dateCellRender = (date: Dayjs) => {
    ...
    return (
      <ul className="events">
        ...
        <Droppable droppableId="scheduledBooks"> {/* Use a constant string as droppableId */}
          {(provided) => (
