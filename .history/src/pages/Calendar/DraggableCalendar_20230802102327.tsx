...
import "moment/locale/en-Malaysia";
...
const DraggableCalendar: React.FC = () => {
  ...
  return (
    ...
    locale={{
      lang: {
        locale: "en-my", // Set the locale to English - Malaysia
        today: "Today",
        now: "Now",
        backToToday: "Back to Today",
      },
      timePickerLocale: {
        placeholder: "Pilih masa", // Use the localized placeholder for selecting time in Malaysia
      },
    }}
      events={events}
