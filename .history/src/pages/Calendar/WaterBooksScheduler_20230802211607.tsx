  ...
  const [selectedDate, setSelectedDate] = useState<Dayjs | null>(null);
    ...
    const mockScheduledBooks: Record<string, EventData[]> = {
      '02-08-2023': [
        {
          id: generateUniqueID(),
          content: 'Event 1', // Add the 'content' property
          date: '02-08-2023',
          reader: 'John Doe',
          bookNo: 'B001',
          totalBooks: '5',
          bookDescription: 'Fantasy Novel',
        },
        {
          id: generateUniqueID(),
          content: 'Event 2', // Add the 'content' property
          date: '02-08-2023',
          reader: 'Jane Smith',
          bookNo: 'B002',
          totalBooks: '3',
          bookDescription: 'Mystery Thriller',
        },
      ...
      '26-07-2023': [
        {
          id: generateUniqueID(),
          content: 'Event 3', // Add the 'content' property
          date: '26-07-2023',
          reader: 'Alice Johnson',
          bookNo: 'B003',
          totalBooks: '2',
          bookDescription: 'Science Fiction',
        },
        // Add more events as needed
      ],
    };
