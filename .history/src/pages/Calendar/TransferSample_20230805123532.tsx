...
interface RowSelectionType {
  getCheckboxProps: (item: DataType) => { disabled: boolean };
  onSelectAll: (selected: boolean, selectedRows: DataType[]) => void;
  onSelect: (data: TransferItem, selected: boolean) => void;
    ...
    {({
      ...
      const rowSelection: RowSelectionType = {
        ...
        onSelect({ key }: TransferItem, selected: boolean) {
          // Function to handle selecting individual rows
          onItemSelect(key as string, selected);
        },
        selectedRowKeys: listSelectedKeys,
        fixed: direction === "left" ? "right" : undefined,
        // Set "right" for leftTableColumns and undefined for rightTableColumns
      };

      return (
        <Table<DataType>
          rowSelection={rowSelection} // This is where the checkboxes are controlled
          columns={columns}
