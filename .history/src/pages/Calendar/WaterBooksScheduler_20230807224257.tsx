...
const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({ theme }) => {
  ...
  // Use the renderSingleRowCalendar function to render the single-row calendar
  const singleRowCalendar = renderSingleRowCalendar(
    selectedDate,
    handleDateSelect,
    selectedRightTableColumnDate,
  ...
  const dateCellRender = (date: Dayjs) => {
    ...
    return (
      <ul className="events">
        ...
        {showSingleRow && singleRowCalendar}
