  ...
  return (
    <>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        ...
        >
          ...
          >
            ...
            />
            <div>
              {console.log("Current cell date:", date.format("DD-MM-YYYY"))};
              {console.log(
      ...
      <TableTransfer
        ...
        selectedRightTableColumnDate={setSelectedRightTableColumnDate} // Pass the selectedRightTableColumnDate as a prop
