...
interface EventData {
  ...
  interface WaterBooksPreviousMonthReschedulingFormProps {
    theme: Theme;
    isEventSelected: boolean; // Add isEventSelected property to indicate whether an event is selected
    selectedEvent: EventData | undefined; // Allow EventData | undefined as the type
    onCancel: () => void;
    onApply: () => void;
    currentScheduledDate: Dayjs;
  }


const WaterBooksScheduler: React.FC<WaterBooksSchedulerProps> = ({   theme,
  isEventSelected, // Use isEventSelected instead of selectedEvent to determine if an event is selected
  selectedEvent,
  onCancel,
  onApply,
