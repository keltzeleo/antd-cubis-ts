        ...
        title: (
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div
              ...
              onMouseEnter={() => setStatusFilters([])} // Clear filters when mouse enters the icon area
            >
              <SearchOutlined
                onMouseEnter={() => setStatusFilters([])} // Clear filters when mouse enters the icon area
                onClick={(e) => e.stopPropagation()} // Stop propagation to prevent closing the Drawer on icon click
              />
              {statusFilters.length > 0 && (
                <div
                  ...
                  onMouseLeave={() => setStatusFilters([])} // Clear filters when mouse leaves the checkbox area
                >
                  <Checkbox.Group
  options={["assigned", "cancelled", "failed to visit", "reassigning", "rescheduled"]}
  value={statusFilters}
  onChange={(event: CheckboxChangeEvent) => {
    ...
    setStatusFilters(
      checked
        ...
        : statusFilters.filter((value) => value !== event.target.value)
    );
  }}
/>
                </div>
